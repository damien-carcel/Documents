...
echo $this->Form->input('name', array('label' => 'Nom du dossier')), "\n";
echo $this->Form->input('parent', array('default' => $previousId, 'type' => 'hidden')), "\n";
echo $this->Form->end('Créer le dossier'), "\n";
